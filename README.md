...
- **[Rewrite](https://github.com/SSBun/Rewrite)** - Menu bar Mac app to fix grammar for selected text with custom OpenAI models and prompts
- **[FlyCoding](https://github.com/SSBun/FlyCoding)** - Xcode extension like Emmet for generating Swift/Objective-C code quickly
